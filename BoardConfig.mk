...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := pickle
...
# Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_pickle
TARGET_RECOVERY_DEVICE_MODULES := libinit_pickle
...
ifeq ($(IS_GLOBAL),true)
TARGET_PREBUILT_KERNEL := $(PICKLE_PREBUILT)/base/Global/Image.gz
TARGET_PREBUILT_DTB := $(PICKLE_PREBUILT)/base/Global/dtb.img
BOARD_PREBUILT_DTBOIMAGE := $(PICKLE_PREBUILT)/base/Global/dtbo.img
else
TARGET_PREBUILT_KERNEL := $(PICKLE_PREBUILT)/base/China/Image.gz
TARGET_PREBUILT_DTB := $(PICKLE_PREBUILT)/base/China/dtb.img
BOARD_PREBUILT_DTBOIMAGE := $(PICKLE_PREBUILT)/base/China/dtbo.img
endif
...
TARGET_KERNEL_CONFIG := pickle_user_defconfig
...
ifeq ($(IS_GLOBAL),true)
BOARD_PREBUILT_VENDORIMAGE := $(PICKLE_PREBUILT)/vendor/Global/vendor.img
BOARD_PREBUILT_ODMIMAGE := $(PICKLE_PREBUILT)/base/Global/odm.img
else
BOARD_PREBUILT_VENDORIMAGE := $(PICKLE_PREBUILT)/vendor/China/vendor.img
BOARD_PREBUILT_ODMIMAGE := $(PICKLE_PREBUILT)/base/China/odm.img
endif
