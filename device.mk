...
# Fstab in ramdisk
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/etc/fstab.mt6895:$(TARGET_COPY_OUT_RAMDISK)/first_stage_ramdisk/fstab.mt6895 \
    $(LOCAL_PATH)/rootdir/etc/fstab.mt6895:$(TARGET_COPY_OUT_RAMDISK)/first_stage_ramdisk/fstab.mt6895 \
...
PRODUCT_PACKAGES += \
    FrameworkResOverlayPickle \
    WifiResOverlayPickle \
    SystemUIOverlayPickle \
    TelephonyOverlayPickle
